...
<section id="content" class="m-t-lg wrapper-md animated fadeInUp">
    <div class="container aside-xxl">
        <a class="text-center block" href="index.html" style="color:palegreen; font-weight: 200; font-size: 25px; margin-top: 20px;line-height: 1.0;" data-toggle="fullscreen">ORDER MANAGEMENT SYSTEM</a>
