                ...
                {!! Form::model($order, array('method'=>'PATCH','route' => array('order.update', $order->id))) !!}
                    ...
                    <div class="col-sm-6">
                         <div class="form-group">
                            ...
                            {!! Form::date('order_date', null, [ 'class'=>'form-control input-lg','required']) !!}
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('quantity', null, ['placeholder'=>'Enter quantity', 'class'=>'form-control input-lg','required']) !!}
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Amount</label>
                                    {!! Form::number('amount', null, ['placeholder'=>'Enter total amount', 'class'=>'form-control input-lg','required']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
